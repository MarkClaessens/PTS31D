 ...
 * @version 1.3
 *
 * de methode removeAllListeners verwijderd omdat er anders onbewust of
 * onterecht listeners worden verwijderd waarover de opdrachtgever geen rechten
 * heeft; de specificatie van addListener is aangescherpt ivm toegestane
 * properties.
 */
